        ...
        context 'valid data' do
          ...
          it 'creates new user' do
            VCR.use_cassette('create user with photo') do
              ...
              expect(json_attributes['photo']['url']).to include('http://res.cloudinary.com/')
              expect(json_attributes['photo']['mini']['url']).to include('http://res.cloudinary.com/')
              expect(json_attributes['photo']['medium']['url']).to include('http://res.cloudinary.com/')
              expect(json_attributes['photo']['thumb']['url']).to include('http://res.cloudinary.com/')
            end
          end
        end
